package com.mesosphere.sdk.debsvcframework.scheduler;
...
public class ServiceTest {
    ...
    public void testSpec() throws Exception {
        ...
        ticks.add(Send.offerBuilder("debsvcframework").build());
        ticks.add(Expect.launchedTasks("debsvcframework-0-node"));
        ticks.add(Send.taskStatus("debsvcframework-0-node", Protos.TaskState.TASK_ERROR).build());
        ...
        ticks.add(Send.offerBuilder("debsvcframework").setPodIndexToReoffer(0).build());
        ticks.add(Expect.launchedTasks("debsvcframework-0-node"));
        ticks.add(Send.taskStatus("debsvcframework-0-node", Protos.TaskState.TASK_RUNNING).build());
